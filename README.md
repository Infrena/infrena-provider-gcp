...
The Google Cloud provider for [infrena](https://github.com/Infrena/infrena). It serves **289
resource types** across 40 GCP services, generated from Google's own API Discovery documents with a
...
**The catalog does not cover all of GCP, and the gap is deliberate.** 289 types ship; 327 entries
