...
| --- | --- | --- |
| Create | yes | `POST projects/{{project}}/global/sslPolicies` |
| Read | yes | `GET projects/{project}/global/sslPolicies/{sslPolicy}` |
| Update | yes | `PATCH projects/{project}/global/sslPolicies/{sslPolicy}` |
| Delete | yes | `DELETE projects/{project}/global/sslPolicies/{sslPolicy}` |
...
| `region` | — | `string` | output only | — | Output only. \[Output Only\] URL of the region where the regional SSL policy resides. This field is not applicable to global SSL policies. |
