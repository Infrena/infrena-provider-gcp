...
| `secondaryIpRanges[].rangeName` | `range_name` | `string` | optional | — | The name associated with this subnetwork secondary range, used when adding an alias IP/IPv6 range to a VM instance. The name must be 1-63 characters long, and comply withRFC1035. The name must be … |
