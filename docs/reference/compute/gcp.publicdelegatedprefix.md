...
| `ipCidrRange` | `ip_cidr_range` | `string` | required | — | The IP address range, in CIDR format, represented by this public delegated prefix. |
...
| `parentPrefix` | `parent_prefix` | `string` | required | — | The URL of parent prefix. Either PublicAdvertisedPrefix or PublicDelegatedPrefix. |
| `publicDelegatedSubPrefixs` | `public_delegated_sub_prefixs` | `list` | output only | — | The list of sub public delegated prefixes that exist for this public delegated prefix. |
