...
| `adaptiveProtectionConfig.layer7DdosDefenseConfig.thresholdConfigs[].trafficGranularityConfigs[].type` | — | `string` | optional | — | Type of this configuration. |
...
| `rules[].rateLimitOptions.exceedRedirectOptions.type` | — | `string` | optional | — | Type of the redirect action. Possible values are: - GOOGLE_RECAPTCHA: redirect to reCAPTCHA for manual challenge assessment. - EXTERNAL_302: redirect to a different URL via a 302 response. |
...
| `rules[].redirectOptions.type` | — | `string` | optional | — | Type of the redirect action. Possible values are: - GOOGLE_RECAPTCHA: redirect to reCAPTCHA for manual challenge assessment. - EXTERNAL_302: redirect to a different URL via a 302 response. |
