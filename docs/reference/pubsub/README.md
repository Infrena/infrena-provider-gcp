...
| --- | --- | --- | --- | --- |
| [`gcp.pubsub.schema`](gcp.pubsub.schema.md) | yes | yes | yes | A schema is a format that messages must follow, creating a contract between publisher and subscriber that Pub/Sub will enforce. |
