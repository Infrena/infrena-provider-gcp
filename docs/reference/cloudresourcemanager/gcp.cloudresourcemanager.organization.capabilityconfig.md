...
| `capability_config_id` | — | `string` | required | force new | The capability_config_id this gcp.cloudresourcemanager.organization.capabilityconfig belongs to. It is part of the resource's name, supplied in the create url rather than in the request body. |
