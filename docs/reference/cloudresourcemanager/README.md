...
| [`gcp.cloudresourcemanager.folder.capabilityconfig`](gcp.cloudresourcemanager.folder.capabilityconfig.md) | yes | yes | yes | Capability configs define the enabled capabilities and their scope of enforcement for folders, organizations, or projects within the … |
...
| [`gcp.cloudresourcemanager.organization.capabilityconfig`](gcp.cloudresourcemanager.organization.capabilityconfig.md) | yes | yes | yes | Capability configs define the enabled capabilities and their scope of enforcement for folders, organizations, or projects within the … |
